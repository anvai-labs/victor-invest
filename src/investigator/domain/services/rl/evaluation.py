...
def newey_west_tstat(returns: Sequence[float | None], lags: int | None = None) -> SignificanceResult:
...
def evaluate_reward_significance(
    ...
    *,
    ...
    rewards: list[float | None] = [r.get(reward_key) for r in rows]
