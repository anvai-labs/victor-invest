...
class MonteCarloSimulator:
    ...
    def simulate_geometric_brownian_motion(
        ...
        """
        logger.info(f"Running GBM simulation for {symbol}: {simulations} paths, {time_horizon_days} days")
        ...
        logger.info(
            f"GBM simulation complete for {symbol}: "
    ...
    def simulate_from_historical_data(
        ...
        """
        logger.info(
            f"Running historical simulation for {symbol}: "
