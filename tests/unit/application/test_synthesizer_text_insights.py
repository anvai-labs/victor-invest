...
def test_extract_comprehensive_insights_includes_technical_and_catalysts():
    llm_responses = {
        "fundamental": {"a": {"content": "Key Insights: - Durable pricing power - Improving retention"}},
        "technical": {"content": "KEY INSIGHTS: - Breakout above resistance - Volume confirmation\n\nNEXT SECTION"},
    }
