...
cli_main = importlib.import_module("investigator.cli.main")
...
def test_victor_external_vertical_noise_filter_suppresses_known_messages():
    noise_filter = cli_main._VictorExternalVerticalNoiseFilter()
...
def test_victor_external_vertical_noise_filter_keeps_other_messages():
    noise_filter = cli_main._VictorExternalVerticalNoiseFilter()
